...
public class WebJarAssetLocator {
	 ...
	 * 
	 * @param filterExpr
	 *            the regular expression to be used to filter resources that will be included in the index.
	 * @param classLoaders
	 *            the class loaders to be considered for loading the resources from.
	 * @return the index.
	 */
	 ...
	 * 
	 * @param partialPath
	 *            the path to return e.g. "jquery.js" or "abc/someother.js". This must be a distinct path within the index passed in.
