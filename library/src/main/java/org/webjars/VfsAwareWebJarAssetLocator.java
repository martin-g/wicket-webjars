 ...
 */
public class VfsAwareWebJarAssetLocator {
    ...
    /*
     * Return all {@link URL}s defining {@value VfsAwareWebJarAssetLocator#WEBJARS_PATH_PREFIX} directory, either identifying JAR files or plain directories.
     */
     ...
     * current class path.
     */
    public VfsAwareWebJarAssetLocator() {
     ...
     */
    public VfsAwareWebJarAssetLocator(final SortedMap<String, String> fullPathIndex) {
